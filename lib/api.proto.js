    ...
    $root.api = (function() {
        ...
        api.Credentials = (function() {
            ...
            Credentials.S3Post = (function() {
                 ...
                 * @property {string|null} [xAmzAlgorithm] S3Post xAmzAlgorithm
                 * @property {string|null} [xAmzServerSideEncryption] S3Post xAmzServerSideEncryption
                 * @property {string|null} [xAmzCredential] S3Post xAmzCredential
                 * @property {string|null} [xAmzDate] S3Post xAmzDate
                 * @property {string|null} [xAmzSignature] S3Post xAmzSignature
                 * @property {string|null} [xAmzSecurityToken] S3Post xAmzSecurityToken
                 */
                ...
                /**
                 * S3Post xAmzAlgorithm.
                 * @member {string} xAmzAlgorithm
                 * @memberof api.Credentials.S3Post
                 * @instance
                 */
                S3Post.prototype.xAmzAlgorithm = "";
    
                /**
                 * S3Post xAmzServerSideEncryption.
                 * @member {string} xAmzServerSideEncryption
                 * @memberof api.Credentials.S3Post
                 * @instance
                 */
                S3Post.prototype.xAmzServerSideEncryption = "";
    
                /**
                 * S3Post xAmzCredential.
                 * @member {string} xAmzCredential
                 * @memberof api.Credentials.S3Post
                 * @instance
                 */
                S3Post.prototype.xAmzCredential = "";
                 ...
                 * @instance
                 */
                S3Post.prototype.xAmzDate = "";
    
                /**
                 * S3Post xAmzSignature.
                 * @member {string} xAmzSignature
                 * @memberof api.Credentials.S3Post
                 * @instance
                 */
                S3Post.prototype.xAmzSignature = "";
    
                /**
                 * S3Post xAmzSecurityToken.
                 * @member {string} xAmzSecurityToken
                 * @memberof api.Credentials.S3Post
                 * @instance
                 */
                S3Post.prototype.xAmzSecurityToken = "";
                ...
                S3Post.encode = function encode(message, writer) {
                    ...
                    if (message.xAmzAlgorithm != null && message.hasOwnProperty("xAmzAlgorithm"))
                        writer.uint32(/* id 5, wireType 2 =*/42).string(message.xAmzAlgorithm);
                    if (message.xAmzServerSideEncryption != null && message.hasOwnProperty("xAmzServerSideEncryption"))
                        writer.uint32(/* id 6, wireType 2 =*/50).string(message.xAmzServerSideEncryption);
                    if (message.xAmzCredential != null && message.hasOwnProperty("xAmzCredential"))
                        writer.uint32(/* id 7, wireType 2 =*/58).string(message.xAmzCredential);
                    if (message.xAmzDate != null && message.hasOwnProperty("xAmzDate"))
                        writer.uint32(/* id 8, wireType 2 =*/66).string(message.xAmzDate);
                    if (message.xAmzSignature != null && message.hasOwnProperty("xAmzSignature"))
                        writer.uint32(/* id 9, wireType 2 =*/74).string(message.xAmzSignature);
                    if (message.xAmzSecurityToken != null && message.hasOwnProperty("xAmzSecurityToken"))
                        writer.uint32(/* id 10, wireType 2 =*/82).string(message.xAmzSecurityToken);
                    return writer;
                };
                ...
                S3Post.decode = function decode(reader, length) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            message.xAmzAlgorithm = reader.string();
                            break;
                        case 6:
                            message.xAmzServerSideEncryption = reader.string();
                            break;
                        case 7:
                            message.xAmzCredential = reader.string();
                            break;
                        case 8:
                            message.xAmzDate = reader.string();
                            break;
                        case 9:
                            message.xAmzSignature = reader.string();
                            break;
                        case 10:
                            message.xAmzSecurityToken = reader.string();
                            break;
                        default:
                            reader.skipType(tag & 7);
                            break;
                ...
                S3Post.verify = function verify(message) {
                    ...
                    if (message.xAmzAlgorithm != null && message.hasOwnProperty("xAmzAlgorithm"))
                        if (!$util.isString(message.xAmzAlgorithm))
                            return "xAmzAlgorithm: string expected";
                    if (message.xAmzServerSideEncryption != null && message.hasOwnProperty("xAmzServerSideEncryption"))
                        if (!$util.isString(message.xAmzServerSideEncryption))
                            return "xAmzServerSideEncryption: string expected";
                    if (message.xAmzCredential != null && message.hasOwnProperty("xAmzCredential"))
                        if (!$util.isString(message.xAmzCredential))
                            return "xAmzCredential: string expected";
                    if (message.xAmzDate != null && message.hasOwnProperty("xAmzDate"))
                        if (!$util.isString(message.xAmzDate))
                            return "xAmzDate: string expected";
                    if (message.xAmzSignature != null && message.hasOwnProperty("xAmzSignature"))
                        if (!$util.isString(message.xAmzSignature))
                            return "xAmzSignature: string expected";
                    if (message.xAmzSecurityToken != null && message.hasOwnProperty("xAmzSecurityToken"))
                        if (!$util.isString(message.xAmzSecurityToken))
                            return "xAmzSecurityToken: string expected";
                    return null;
                };
                ...
                S3Post.fromObject = function fromObject(object) {
                    ...
                    if (object.xAmzAlgorithm != null)
                        message.xAmzAlgorithm = String(object.xAmzAlgorithm);
                    if (object.xAmzServerSideEncryption != null)
                        message.xAmzServerSideEncryption = String(object.xAmzServerSideEncryption);
                    if (object.xAmzCredential != null)
                        message.xAmzCredential = String(object.xAmzCredential);
                    if (object.xAmzDate != null)
                        message.xAmzDate = String(object.xAmzDate);
                    if (object.xAmzSignature != null)
                        message.xAmzSignature = String(object.xAmzSignature);
                    if (object.xAmzSecurityToken != null)
                        message.xAmzSecurityToken = String(object.xAmzSecurityToken);
                    return message;
                };
                ...
                S3Post.toObject = function toObject(message, options) {
                    ...
                    if (options.defaults) {
                        ...
                        object.xAmzServerSideEncryption = "";
                    ...
                    if (message.xAmzAlgorithm != null && message.hasOwnProperty("xAmzAlgorithm"))
                        object.xAmzAlgorithm = message.xAmzAlgorithm;
                    if (message.xAmzServerSideEncryption != null && message.hasOwnProperty("xAmzServerSideEncryption"))
                        object.xAmzServerSideEncryption = message.xAmzServerSideEncryption;
                    if (message.xAmzCredential != null && message.hasOwnProperty("xAmzCredential"))
                        object.xAmzCredential = message.xAmzCredential;
                    if (message.xAmzDate != null && message.hasOwnProperty("xAmzDate"))
                        object.xAmzDate = message.xAmzDate;
                    if (message.xAmzSignature != null && message.hasOwnProperty("xAmzSignature"))
                        object.xAmzSignature = message.xAmzSignature;
                    if (message.xAmzSecurityToken != null && message.hasOwnProperty("xAmzSecurityToken"))
                        object.xAmzSecurityToken = message.xAmzSecurityToken;
                    return object;
                };
